...
import com.topsTshirtPOM.SignOut;

public class PageObjectManagerEveningDress{
	public static WebDriver driver;
	public static HomePageEveningDress hp;
    ...
    public PageObjectManagerEveningDress(WebDriver driver2) {
		this.driver=driver2;
	}
	public HomePageEveningDress getInstanceHP() {
		if(hp==null) {
			hp=new HomePageEveningDress(driver);
		}
		return hp;
	}
