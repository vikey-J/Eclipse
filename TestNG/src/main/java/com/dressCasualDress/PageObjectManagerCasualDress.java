...
public class PageObjectManagerCasualDress{
	public static WebDriver driver;
	public static HomePageCasualDress hp;
    ...
    public PageObjectManagerCasualDress(WebDriver driver2) {
		this.driver=driver2;
	}
	public HomePageCasualDress getInstanceHP() {
		if(hp==null) {
			hp=new HomePageCasualDress(driver);
		}
		return hp;
	}
