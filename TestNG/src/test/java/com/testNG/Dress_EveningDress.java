...
import com.topsBlousesPOM.PageObjectManager_B;

public class Dress_EveningDress extends Base_Class {
	public static WebDriver driver = getBrowser("chrome");
	public static PageObjectManagerEveningDress pom = new PageObjectManagerEveningDress(driver);
	...
	public static void main(String[] args) {
		...
		click(pom.getInstanceHP().getEveningDress());
		// add to cart
		implicitWait(10, TimeUnit.SECONDS);
