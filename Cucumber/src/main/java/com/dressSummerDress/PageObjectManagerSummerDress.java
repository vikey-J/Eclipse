...
public class PageObjectManagerSummerDress{
	public static WebDriver driver;
	public static HomePageSummerDress hp;
    ...
    public PageObjectManagerSummerDress(WebDriver driver2) {
		this.driver=driver2;
	}
	public HomePageSummerDress getInstanceHP() {
		if(hp==null) {
			hp=new HomePageSummerDress(driver);
		}
		return hp;
	}
